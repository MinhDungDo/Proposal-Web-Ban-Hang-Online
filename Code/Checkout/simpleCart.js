        ...
        generateSimpleCart = function (space) {
            ...
            cartColumnViews = {
                ...
                image: function (item, column) {
                    return "<img src='" + item.get(column.attr) + "' style='width: 150px;height: 117px;'/>";
                },

                input: function (item, column) {
                    return "<input type='text' pattern='[0-9]' value='" + item.get(column.attr) + "' class='" + namespace + "_input form-control'/>";
                },
            ...
            simpleCart.extend({
                ...
                createCartRow: function (item, y, TR, TD, container) {
                    ...
                    for (j = 0, jlen = settings.cartColumns.length; j < jlen; j += 1) {
                        ...
                        cell = simpleCart.$create(TD).addClass(klass).html(content).attr("style", "vertical-align: middle");
